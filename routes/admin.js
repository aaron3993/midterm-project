...
module.exports = ({
  ...
  router.get("/", (req, res) => {
    ...
    fetchOrdersByStatus("pending").then((pendingOrders) => {
      ...
      fetchOrderDetailsByStatus("pending").then((pendingOrderDetails) => {
        ...
        fetchOrdersByStatus("confirmed").then((confirmedOrders) => {
